...
def main():
    ...
    rhel6_filtered_repo_mirror = gr.get_repo_specifics(gr.get_rhel6_repo_files())
    rhel7_filtered_repo_mirror = gr.get_repo_specifics(gr.get_rhel7_repo_files())
    rhel8_filtered_repo_mirror = gr.get_repo_specifics(gr.get_rhel8_repo_files())
